...
app.controller('desktopEmailValidator', ['$scope', function($scope) {
    ...
    /*$scope.noSubjectProvidedForOtherTypeOfBusinessInquiryOrPublicRelations = function() {
        return ($scope.theBusinessInquiryOptionSelectedIsOther() || $scope.thePublicRelationsOptionSelectedIsOther()) && $scope.email.subject.length === 0;
    }*/
}]);